...
// A Cloudflare Pages Function — runs on Cloudflare's servers, not in the
// browser, so the OpenAI API key never reaches the client. Deployed
// automatically because it lives in /functions; Cloudflare Pages maps
// this file to the route POST /analyze.
//
// Required setup (done once in the Cloudflare Pages dashboard):
//   Settings → Environment variables → add a "Secret":
//     Name:  OPENAI_API_KEY
